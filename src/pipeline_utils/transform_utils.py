...
def transform_data(extracted_data):
    """
        ...
        Returns:
            filtered_resources (list): All 'resource' dicts flattened and filtered inside a list.
    ...
    # Returns the new flattened, filtered list of all dictionaries in all json files.
